...
export default function WorkflowsClient({ workflows }: WorkflowsClientProps) {
  ...
  const categories = Array.from(new Set(workflows.map((workflow) => workflow.category).filter(Boolean)))
  ...
  const filteredWorkflows = workflows.filter((workflow) => {
    ...
    const matchesCategory =
      selectedCategory === "" || workflow.tags?.includes(selectedCategory) || workflow.category === selectedCategory
